...
class ChatHandler(BaseHTTPRequestHandler):
    ...
    def _handle_message(self) -> None:
        ...
        result = bot.respond(user_message)
        learned_score = bot.learn(user_message, source="chat")
        self._send_json({"reply": result["text"], "score": result["score"], "patterns": result["patterns"], "learned_score": learned_score, "stats": bot.stats()})
